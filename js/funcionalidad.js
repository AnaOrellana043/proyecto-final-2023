...
$.ajax({
    ...
    success: function(data) {
        ...
        nombrePersona.innerText=nombre.toUpperCase();
...
modo.addEventListener ("click", function(){
    if (modo.className.includes("fa-sun")){
        ...
        document.documentElement.style.setProperty('--color-1', '#865734');
        document.documentElement.style.setProperty('--color-2', '#b98660');
        document.documentElement.style.setProperty('--color-3', '#2c1906');
        document.documentElement.style.setProperty('--color-pagina', '#865734');
        ...
        document.documentElement.style.setProperty('--color-1', '#e1b230 ');
        document.documentElement.style.setProperty('--color-2', '#d08a48');
        document.documentElement.style.setProperty('--color-3', '#945616');
